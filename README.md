...
糖果球飞行时，右下角会出现一次性技能按钮：普通球冲刺、重球下坠、弹力球跃起、爆爆球空中引爆，以及彩虹分裂球的三向分裂。

糖果球出界或稳定停下后会自动进入下一球；连续碰撞会聚合为一条清晰的得分与连击提示。游戏包含本地程序化短音效，右上角音符按钮可以随时静音，设置会保存在本机。

每关会实时显示目标完成度和三星进度；达到星级线会立即点亮星星，结果页会记录一发制胜、过关发数和本关新纪录。

当前包含 25 个关卡，分为“甜甜岛”“彩虹岛”“宝藏岛”“汽水岛”四个章节。第 11–15 关加入双向彩虹传送门；第 16–20 关加入需要连续命中三次、逐步裂开并喷出奖励的糖果宝箱；第 21–25 关围绕可主动分裂为三球的彩虹分裂球设计。
